...
export function BookSessionModal({ tutor }) {
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      // NO SLOT LEFT
      if (!res.ok) {
        toast.error(data.message || "No slots left");
        return;
      }
  ...
  return (
    <>
      ...
      >
        {tutor.remainingSlots <= 0 ? "No Slot Left" : "Book Session"}
      </Button>
          ...
          <Modal.Container>
            <Modal.Dialog className="sm:max-w-[440px] bg-[#0b1220] text-white rounded-2xl border border-white/10">
              ...
              <Modal.Body className="space-y-5">
                ...
                {/* Tutor Email */}
                <div>
                  <p className="text-sm text-gray-400 mb-1">Tutor Email</p>
